...
cursor = banco.cursor()
filename2023j = "janeiro02012023_1.pdf"
filename2023f = "fevereiro08022023.pdf"
filename2011j = "janeiro032011.pdf"
...
data = tabula.read_pdf(filename2024j, multiple_tables=True, pages="all", stream=True, guess=False, encoding='latin-1')
if data:
