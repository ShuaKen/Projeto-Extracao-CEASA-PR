                    ...
                    if len(selected_data) >= 1 :
                        for i in selected_data:
                            ...
                            if produtos_ausentes >= 1:
                                continue
                            if 'produto' in find_unidade.lower() or 'centrais' in find_unidade.lower() or 'mercado '.lower() in find_unidade or 'fonte' in find_unidade.lower() or 'c o t a ' in find_unidade.lower() or '#REF!' in find_unidade or '[nan' in str(i) or 'legenda' in find_comeco.lower() or 'coleta' in find_comeco.lower() or 'data' in find_comeco.lower() or 'embalagem' in find_comeco.lower() or 'm_c' in find_comeco.lower() or 'pesquisa' in find_comeco.lower() or 'endere' in find_comeco.lower() or 'preco' in find_comeco.lower() or 'obs:' in find_comeco.lower() or 'fir -' in find_comeco.lower() or 'fra -' in find_comeco.lower() or 'est -' in find_comeco.lower() or 'aus -' in find_comeco.lower() or 'cep:' in find_comeco.lower()  or 'situa' in find_comeco.lower() or 'produto indispon' in find_unidade or 'telefone' in find_comeco.lower():
                                continue
